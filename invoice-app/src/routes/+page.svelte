...
<main class="min-h-screen bg-white dark:bg-black text-slate-900 dark:text-white transition-colors">
  ...
  <!-- TURNING IDEAS -->
  <section
    class="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center"
  >
  ...
  <!-- OUR SERVICES -->
  <section
    class="bg-slate-50 dark:bg-[#0d0d0d] py-20 px-6 transition-colors"
  >
      ...
      >
        ...
        <div class="space-y-3">
          ...
          {#each services as s, i}
            ...
            <div
              class="flex items-center justify-between rounded-xl bg-white dark:bg-[#161616] border border-slate-200 dark:border-white/10 px-5 py-4"
            >
        ...
        <div class="grid grid-rows-2 gap-4">
          ...
          >
            ...
            <button
              onclick={() => goto('/editor')}
              class="font-semibold flex items-center gap-1 cursor-pointer"
            >
              {lang.t('hero_cta')}
              <span>→</span>
            </button>
