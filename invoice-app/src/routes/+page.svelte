...
<div class="min-h-screen bg-white dark:bg-black text-slate-900 dark:text-white transition-colors">
  ...
  <main class={sidebarOpen ? 'lg:pl-64' : ''}>
    ...
    <!-- TOP UTILITY BAR: toggle sidebar + bahasa + dark mode -->
    <div class="flex justify-between items-center gap-2 px-4 sm:px-6 pt-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative">
          ...
          <span class="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-xs opacity-60">
            ▾
          </span>
        </div>
    ...
    <section class="px-4 pt-2">
      ...
      <div class="max-w-5xl mx-auto rounded-[2rem] overflow-hidden bg-[#111] dark:bg-white text-white dark:text-[#111] transition-colors">

        <div class="px-6 md:px-12 py-12 md:py-16 flex flex-col md:flex-row items-center gap-10">
    ...
    <!-- ================= TURNING IDEAS ================= -->
    <section class="max-w-5xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-8">
          ...
          <div class="space-y-3">
            {#each services as s, i}
              <div class="flex items-center justify-between rounded-xl bg-white dark:bg-[#161616] border border-slate-200 dark:border-white/10 px-5 py-4 hover:-translate-y-0.5 hover:shadow-sm transition">
          ...
          <div class="grid grid-rows-2 gap-4">
            ...
            <div class="rounded-xl bg-white dark:bg-[#161616] border border-slate-200 dark:border-white/10 p-5">
              ...
              <a href="/templates" class="font-semibold flex items-center gap-1" style="color:#8CFF3D">
                Lihat Template
                <span>→</span>
              </a>
            </div>
    ...
    <footer class="px-4 pb-4">
      ...
      <div class="max-w-5xl mx-auto rounded-[2rem] overflow-hidden" style="background:#8CFF3D">
